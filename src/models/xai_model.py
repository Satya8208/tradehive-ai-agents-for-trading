"""
TradeHive's xAI Grok Model Implementation
"""
...
class XAIModel(BaseModel):
    ...
    AVAILABLE_MODELS = {
        "grok-4.3": {
            "description": "Current xAI flagship model",
            "context_window": "1M+ tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4.20-0309-reasoning": {
            "description": "Pinned Grok 4.20 reasoning snapshot visible on the xAI API",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4.20-0309-non-reasoning": {
            "description": "Pinned Grok 4.20 non-reasoning snapshot visible on the xAI API",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4.20-multi-agent-0309": {
            "description": "Pinned Grok 4.20 multi-agent snapshot visible on the xAI API",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4.20-reasoning": {
            "description": "Current xAI reasoning model for text, vision, and agentic tasks",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4.20": {
            "description": "Current xAI flagship model alias",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4.20-multi-agent": {
            "description": "xAI multi-agent research model; can use 4 or 16 agents via reasoning.effort",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
        "grok-4-1-fast": {
            "description": "Current fast Grok 4.1 model",
            "context_window": "2M tokens",
            "pricing": "See xAI pricing",
            "rate_limits": "See xAI console"
        },
    ...
    def __init__(self, api_key: str, model_name: str = "grok-4.3", base_url: str = "https://api.x.ai/v1", **kwargs):
    ...
    def generate_response(self,
        ...
        **kwargs
        ...
        try:
            cprint(f"xAI Grok {self.model_name} is thinking...", "yellow")
