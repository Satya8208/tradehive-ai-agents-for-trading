"""
🌙 TradeHive's Funding Arbitrage Agent 💰
...
MODEL_OVERRIDE = "deepseek-v4-flash"  # Set to "deepseek-v4-flash" or "deepseek-v4-pro" to use DeepSeek, "0" to use default
...
class FundingArbAgent(BaseAgent):
    ...
    def __init__(self):
        """Initialize TradeHive's Funding Arbitrage Agent"""
        super().__init__('fundingarb')  # Initialize base agent with type

        # Set AI parameters - use config values unless overridden
        self.ai_model = AI_MODEL if AI_MODEL else "claude-sonnet-4-6"
        ...
        if deepseek_key and "deepseek" in MODEL_OVERRIDE.lower():
    ...
    def _analyze_opportunity(self, symbol, data, market_data):
        ...
        try:
            ...
            if self.deepseek_client and "deepseek" in MODEL_OVERRIDE.lower():
            ...
            result = {
                ...
                'model_used': MODEL_OVERRIDE if self.deepseek_client else self.ai_model
            }
    ...
    def _format_announcement(self, symbol, data, analysis):
        ...
        announcement = f"""
        Yo TradeHive seven seven seven! High funding arbitrage opportunity detected!
        ...
        TradeHive's Funding Arbitrage Agent - Making that funding money! 🌙
        """
        return announcement
