...
AI_MODEL_TYPE = 'xai'
AI_MODEL_NAME = None  # None = use default for model type, or specify: 'openai/gpt-oss-120b', 'gpt-5.5', etc.
...
class RealtimeClipsAgent:
    """AI-powered real-time clip creator using TradeHive's Model Factory"""
...
Model Factory Integration:
  - Works with ALL TradeHive models: Claude, GPT, DeepSeek, Groq, Grok, Ollama
...
def main():
    """Main entry point."""
    cprint("\n" + "="*80, "cyan")
    cprint("🌙 TRADEHIVE'S REAL-TIME CLIPS AGENT 🌙", "cyan")
    cprint("="*80, "cyan")
