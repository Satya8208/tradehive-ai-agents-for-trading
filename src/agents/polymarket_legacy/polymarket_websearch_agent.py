"""
🌙 TradeHive's Polymarket Web Search Agent
...
# ==============================================================================
# CONFIGURATION - TradeHive's Web Search Polymarket Agent
# ==============================================================================
...
# 🌙 TradeHive - WEB SEARCH Configuration (NEW!)
...
class PolymarketWebSearchAgent:
    ...
    def __init__(self):
        ...
        cprint("\n" + "="*80, "cyan")
        cprint("🌙 TradeHive's Polymarket WEB SEARCH Agent - Initializing", "cyan", attrs=['bold'])
        ...
        # 🌙 TradeHive - Check OpenAI API key for web search
    ...
    # ==========================================================================
    # 🌙 TradeHive - WEB SEARCH FUNCTIONALITY (NEW!)
    # ==========================================================================

    def search_market_context(self, market_title: str) -> str:
        """
        🌙 TradeHive - Search the web for context about a specific Polymarket market
...
Provide a concise summary of the most relevant and recent information."""
            ...
            if content:
                # 🌙 TradeHive - SHOW THE WEB SEARCH RESULTS
                cprint(f"\n{'─'*60}", "green")
        ...
        try:
            ...
            if isinstance(data, dict):
                if data.get('type') == 'subscribed':
                    cprint("✅ TradeHive WebSocket subscribed to live trades!", "green")
    ...
    # ==========================================================================
    # 🌙 TradeHive - AI PREDICTIONS WITH WEB SEARCH (MODIFIED!)
    # ==========================================================================
    ...
    def get_ai_predictions(self):
        ...
        # ==========================================================================
        # 🌙 TradeHive - SEARCH WEB FOR EACH MARKET BEFORE AI ANALYSIS
        # ==========================================================================
        cprint("\n" + "="*80, "yellow")
        ...
        # ==========================================================================
        # 🌙 TradeHive - BUILD ENRICHED PROMPT WITH WEB CONTEXT
        # ==========================================================================
        cprint("\n" + "="*80, "green")
...
Provide predictions for each market in the specified format."""
            ...
            for market_num, predictions in market_predictions.items():
                if 1 <= market_num <= len(markets_list):
                    ...
                    record = {
                        ...
                        'web_search_used': 'YES',  # 🌙 TradeHive - Mark that web search was used!
    ...
    def _get_top_consensus_picks(self, swarm_result, markets_df):
        ...
        try:
            ...
            cprint(f"🏆 TOP {TOP_MARKETS_COUNT} CONSENSUS PICKS - TRADEHIVE AI (Web Search Enhanced!)", "white", "on_blue", attrs=['bold'])
    ...
    def status_display_loop(self):
        ...
        while True:
            try:
                ...
                cprint(f"\n{'='*60}", "cyan")
                cprint(f"📊 TradeHive Web Search Agent Status @ {datetime.now().strftime('%H:%M:%S')}", "cyan", attrs=['bold'])
                cprint(f"{'='*60}", "cyan")
...
def main():
    """🌙 TradeHive Main - WebSocket + Web Search + AI Analysis"""
    cprint("\n" + "="*80, "cyan")
    cprint("🌙 TradeHive's Polymarket WEB SEARCH Agent!", "cyan", attrs=['bold'])
    ...
    try:
        ...
        cprint("✨ TradeHive Web Search Agent running! Press Ctrl+C to stop.\n", "green", attrs=['bold'])
        while True:
            time.sleep(1)

    except KeyboardInterrupt:
        cprint("\n\n" + "="*80, "yellow")
        cprint("⚠️ TradeHive Polymarket Web Search Agent stopped by user", "yellow", attrs=['bold'])
        cprint("="*80 + "\n", "yellow")
        sys.exit(0)
