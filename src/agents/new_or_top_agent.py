"""
🌙 TradeHive's New & Top Coins Agent 🔍
...
2. Choose AI model by setting MODEL_OVERRIDE at top of file:
   ...
   # For DeepSeek V4 Pro (Better reasoning, more detailed)
   ...
   - DeepSeek V4 Pro: Better for complex market analysis, 
...
class NewOrTopAgent:
    ...
    def __init__(self):
        ...
        print_fancy("🌙 TradeHive's New & Top Coins Agent Initialized! 🌟", 'white', 'on_magenta', SUCCESS_EMOJIS)
    ...
    def run_analysis(self):
        ...
        print_spinner("🚀 Initiating TradeHive Analysis Sequence...", ROCKET_SEQUENCE, 'white', 'on_magenta')
...
def main():
    ...
    print_fancy("\n🌙 TradeHive's Cosmic Token Analysis Starting! 🌟", 'white', 'on_magenta', SUCCESS_EMOJIS)
    agent = NewOrTopAgent()
    ...
    try:
        ...
        print_fancy("\n👋 Agent stopped by user - TradeHive out! 🌙", 'white', 'on_magenta')
    except Exception as e:
