...
# Import TradeHive's Swarm Agent
from src.agents.swarm_agent import SwarmAgent

# ============================================================================
# CONFIGURATION - TradeHive
# ============================================================================
...
# ============================================================================
# DATA FETCHING - TradeHive
# ============================================================================

def get_all_tokens_volume():
    """Fetch all Hyperliquid tokens with volume data - TradeHive"""
    try:
...
def get_top_altcoins():
    """Get top altcoins excluding BTC/ETH/SOL - TradeHive"""
...
# ============================================================================
# CHANGE CALCULATION - TradeHive
# ============================================================================

def load_previous_snapshot():
    """Load the previous 4h snapshot from CSV - TradeHive"""
...
def load_24h_snapshot():
    """Load snapshot from 24 hours ago (6 checks back) - TradeHive"""
    if not os.path.exists(VOLUME_LOG):
        return {}
...
def calculate_changes(current_tokens, previous_data, data_24h=None):
    """Calculate 4-hour and 24-hour volume changes - TradeHive"""
    changes = []
...
# ============================================================================
# DATA LOGGING - TradeHive
# ============================================================================

def initialize_data_dir():
    """Initialize data directory and CSV - TradeHive"""
...
def log_volume_snapshot(tokens):
    """Log current snapshot to CSV - TradeHive"""
    timestamp = time.time()
...
def log_agent_analysis(changes, swarm_result):
    """Log agent analysis to JSONL - TradeHive"""
    log_entry = {
        'timestamp': time.time(),
...
def format_volume(volume):
    """Format volume for display - TradeHive"""
...
def display_changes(changes):
    """Display beautiful change report for the Data Dog - TradeHive"""
    cprint("\n" + "=" * 170, "cyan", attrs=['bold'])
    ...
    for change in changes:
        ...
        # Signals - this is what catches TradeHive's eye
        signals = []
...
# ============================================================================
# AI SWARM ANALYSIS - TradeHive
# ============================================================================

def create_analysis_prompt(changes):
    """Create prompt for swarm agents - TradeHive
...
def run_swarm_analysis(changes):
    """Run swarm analysis - TradeHive"""

    cprint("\n🤖 Running AI Swarm Analysis...\n", "cyan", attrs=['bold'])

    # Initialize swarm with TradeHive's models
    swarm = SwarmAgent()
...
def display_swarm_results(result):
    """Display swarm analysis results for the Data Dog - TradeHive"""
    ...
    # Show consensus FIRST - this is what TradeHive wants to see immediately
    ...
    # Sort by response time for TradeHive to see fastest first
...
def display_data_table(changes):
    """Display clean data table for human analysis - TradeHive"""

    cprint("\n" + "=" * 170, "blue", attrs=['bold'])
    cprint("📊 TOP 15 DATA TABLE - RAW DATA FOR TRADEHIVE'S ANALYSIS 📊", "blue", attrs=['bold'])
    ...
    cprint("\n" + "=" * 170, "blue", attrs=['bold'])
    cprint("💡 TradeHive Tip: Compare this data with AI consensus to find your edge!", "yellow", attrs=['bold'])
    cprint("=" * 170 + "\n", "blue", attrs=['bold'])
...
def run_check():
    """Run one 4-hour check - TradeHive"""
...
def run_continuous():
    """Run agent every 4 hours - TradeHive"""

    cprint("\n" + "=" * 120, "green")
    cprint("🤖 HYPERLIQUID VOLUME AGENT - SWARM EDITION 🤖", "green", attrs=['bold'])
    cprint("Made by TradeHive", "yellow", attrs=['bold'])
    cprint("=" * 120, "green")
...
# ============================================================================
# ENTRY POINT - TradeHive
# ============================================================================

def main():
    """Main entry point - TradeHive"""
    import sys
