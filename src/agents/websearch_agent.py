'''
🌙 TradeHive's Web Search Research Agent 🌙
...
You are TradeHive's Web Search Query Generator 🌙
...
You are TradeHive's Strategy Extraction Agent 🌙
...
def animate_tradehive():
    """Show a fun TradeHive animation"""
    tradehive = [
        "  __  __                         ____                 ",
    ...
    print()
    for i, line in enumerate(tradehive):
...
**🌙 Found by TradeHive's Web Search Agent 🌙**
...
*Generated by TradeHive's Web Search Research Agent*
...
def generate_search_query_with_glm():
    ...
    try:
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/tradehive-ai",
            "X-Title": "TradeHive Web Search Research Agent"
        }
        ...
        # 🌙 TradeHive: Fallback to reasoning field if content is empty (GLM models do this)
...
def extract_strategies_with_glm(md_filepath: Path, source_url: str = "") -> Optional[Dict]:
    ...
    try:
        ...
        headers = {
            ...
            "Content-Type": "application/json",
            "HTTP-Referer": "https://github.com/tradehive-ai",
            "X-Title": "TradeHive Strategy Extraction Agent"
        }
...
def run_continuous_search():
    ...
    animate_tradehive()
    time.sleep(0.5)
    cprint("\n🌟 TRADEHIVE'S WEB SEARCH RESEARCH AGENT - CONTINUOUS MODE 🌟", "white", "on_magenta")
    time.sleep(0.5)
    ...
    try:
        ...
        cprint("\n👋 TRADEHIVE'S WEB SEARCH RESEARCH AGENT SHUTTING DOWN...", "white", "on_yellow")
        cprint(f"Completed {cycle_count} search cycles", "cyan")
        cprint("\n🌙 Thank you for using TradeHive's Web Search Research Agent! 🌙", "white", "on_magenta")
    except Exception as e:
...
def main():
    ...
    # 🌙 TradeHive: Run continuous search loop by default
