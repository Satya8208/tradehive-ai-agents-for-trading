"""
🌙 TradeHive's RBI AI v2.0 (Simplified - Direct DeepSeek)
"""
...
def chat_with_deepseek(system_prompt, user_content, model_name="deepseek-v4-flash"):
...
def chat_with_claude(system_prompt, user_content, model_name="claude-opus-4-7"):
...
def create_backtest(strategy, strategy_name="UnknownStrategy"):
    ...
    output = run_with_animation(
        ...
        "claude-opus-4-7"  # Use Claude Opus 4.7 for complex coding
    )
...
def main():
    """Main function"""
    cprint(f"\n🌟 TradeHive's RBI AI v2.0 (Simplified) Starting Up!", "green")
