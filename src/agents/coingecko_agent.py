...
# Available models:
# - "deepseek-v4-flash" (DeepSeek V4 Flash - fast and efficient)
# - "deepseek-v4-pro" (DeepSeek V4 Pro reasoning model)
# - "0" (Use config.py's AI_MODEL setting)
MODEL_OVERRIDE = "deepseek-v4-flash"  # Set to "0" to disable override
...
Remember to be specific about entry/exit points and always consider TradeHive's risk management rules! 🎯
"""
...
Always consider the bigger picture and help guide TradeHive's long-term strategy! 🚀
"""
...
Keep TradeHive's token tracking clean and organized! 📝
"""
...
Help TradeHive keep track of the trading journey! 🎯
"""

# 🤖 Agent Model Selection
AGENT_ONE_MODEL = MODEL_OVERRIDE if MODEL_OVERRIDE != "0" else "claude-sonnet-4-6"
AGENT_TWO_MODEL = MODEL_OVERRIDE if MODEL_OVERRIDE != "0" else "claude-sonnet-4-6"
TOKEN_EXTRACTOR_MODEL = MODEL_OVERRIDE if MODEL_OVERRIDE != "0" else "claude-sonnet-4-6"
...
def print_banner():
    ...
    cprint("\n" + "="*70, "white", "on_blue")
    cprint("🌙 🎮 TradeHive's Crypto Trading Game! 🎮 🌙", "white", "on_magenta", attrs=["bold"])
    cprint("="*70 + "\n", "white", "on_blue")
...
🌙 TradeHive Wisdom:
[Fun reference to TradeHive's trading style]
"""
            ...
            sections = ["Market Vibes:", "Opportunities I See:", "My Recommendations:", "Portfolio Impact:", "TradeHive Wisdom:"]
...
class CoinGeckoAPI:
    ...
    def __init__(self):
        ...
        print("🦎 TradeHive's CoinGecko API initialized!")
...
class MultiAgentSystem:
    ...
    def __init__(self):
        ...
        cprint("🎮 TradeHive's Trading Game System Ready! 🎮", "white", "on_green", attrs=["bold"])
...
def main():
    ...
    print_banner()
    cprint("🎮 Welcome to TradeHive's Trading Game! 🎮", "white", "on_magenta", attrs=["bold"])
    ...
    try:
        ...
        cprint("\n👋 Thanks for playing TradeHive's Trading Game! 🌙", "white", "on_magenta", attrs=["bold"])
    except Exception as e:
