...
# 🌙 TradeHive: Calculate project root dynamically (MUST be before OG_TWEET_FILE)
...
OG_TWEET_FILE = DATA_DIR / "tweets" / "og_tweet_text.txt"  # 🌙 TradeHive: Dynamic path!
...
class TweetAgent:
    ...
    def __init__(self):
        ...
        # Create tweets directory if it doesn't exist - 🌙 TradeHive: Dynamic path!
