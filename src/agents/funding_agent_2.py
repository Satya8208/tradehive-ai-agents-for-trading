"""
💰 TradeHive's HyperLiquid Funding Rate Scanner
...
class FundingAgent2(BaseAgent):
    ...
    def __init__(self):
        ...
        cprint("💰 TradeHive's HyperLiquid Funding Scanner initialized!", "green")
    ...
    def format_announcement(self, top_3_positive, top_3_negative):
        ...
        try:
            message_parts = ["ayo tradehive seven seven seven! Let me tell you about the funding rate anomalies on HyperLiquid."]
            ...
            message_parts.append("That's all for now! TradeHive out!")
    ...
    def announce(self, message):
        ...
        try:
            cprint(f"\n📢 TradeHive is announcing the funding anomalies...", "yellow")
    ...
    def run_scan_cycle(self):
        ...
        try:
            cprint("\n🚀 Starting TradeHive's Funding Rate Scan...", "green", attrs=['bold'])
            ...
            if top_3_positive is not None and top_3_negative is not None:
                # Print fancy tables
                self.print_fancy_table(top_3_positive, "🌙 Top 3 MOST POSITIVE Funding Rates (TradeHive) 🌙")
                self.print_fancy_table(top_3_negative, "🌙 Top 3 MOST NEGATIVE Funding Rates (TradeHive) 🌙")
            ...
            cprint("\n✨ TradeHive's Funding Scanner cycle completed! ✨", "green", attrs=['bold'])
    ...
    def run(self):
        ...
        cprint("\n🚀 TradeHive's HyperLiquid Funding Scanner Starting...", "green", attrs=['bold'])
        ...
        while True:
            try:
                ...
                cprint("\n👋 TradeHive's Funding Scanner shutting down gracefully...", "yellow")
                break
            except Exception as e:
