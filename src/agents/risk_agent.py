"""
🌙 TradeHive's Risk Management Agent
Built with love by TradeHive 🚀
"""

# Model override settings - Adding DeepSeek support
MODEL_OVERRIDE = "0"  # Set to "deepseek-v4-flash" or "deepseek-v4-pro" to use DeepSeek, "0" to use default
DEEPSEEK_BASE_URL = "https://api.deepseek.com"  # Base URL for DeepSeek API

# 🛡️ Risk Override Prompt - The Secret Sauce!
RISK_OVERRIDE_PROMPT = """
You are TradeHive's Risk Management AI 🛡️
...
class RiskAgent(BaseAgent):
    def __init__(self):
        """Initialize TradeHive's Risk Agent 🛡️"""
    ...
    def get_portfolio_value(self):
        ...
        try:
            print("\n🔍 TradeHive's Portfolio Value Calculator Starting... 🚀")
            ...
            print(f"\n💎 TradeHive's Total Portfolio Value: ${total_value:.2f} 🌙")
            return total_value
        ...
        try:
            ...
            if self.deepseek_client and "deepseek" in MODEL_OVERRIDE.lower():
                ...
                response = self.deepseek_client.chat.completions.create(
                    ...
                    messages=[
                        {"role": "system", "content": "You are TradeHive's Risk Management AI. Analyze positions and respond with OVERRIDE or RESPECT_LIMIT."},
...
"""
            ...
            if self.deepseek_client and "deepseek" in MODEL_OVERRIDE.lower():
                ...
                response = self.deepseek_client.chat.completions.create(
                    model=MODEL_OVERRIDE,
                    messages=[
                        {"role": "system", "content": "You are TradeHive's Risk Management AI. Analyze the breach and decide whether to close positions."},
                        {"role": "user", "content": prompt}
                    ],
                    max_tokens=self.ai_max_tokens,
                    temperature=self.ai_temperature,
