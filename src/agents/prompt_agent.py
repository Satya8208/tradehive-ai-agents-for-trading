'''
🌙 TradeHive's Prompt Enhancement Agent 🌙
...
You are TradeHive's Prompt Enhancement Expert. Your job is to take a basic user prompt
...
def enhance_prompt_with_glm(user_prompt: str) -> Optional[str]:
    ...
    try:
        ...
        headers = {
            ...
            "X-Title": "TradeHive Prompt Enhancement Agent"
        }
...
def interactive_mode():
    ...
    try:
        ...
        cprint("\n🌙 Thanks for using TradeHive's Prompt Enhancement Agent!", "white", "on_magenta")
