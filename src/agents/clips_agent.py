...
https://www.youtube.com/@tradehiveonytsnips
...
steps to your success as a tradehive clipper:
1. find good long videos on my channel: https://www.youtube.com/@tradehiveonyt/videos 
...
payments are via crypto on the 1st and 15th of every month, when you hit 10,000 views per month + just email the link, and your tracking of the views to tradehiveonyt@gmail.com
...
2. you have permission to download any of my youtube videos: https://www.youtube.com/@tradehiveonyt/videos
...
4. post on youtube
5. when you hit 10,000 views email your link and stats to tradehiveonyt@gmail.com to get paid
...
5. wait for 10,000 views and email the link and stats to tradehiveonyt@gmail.com to get paid
...
- you can also download the videos from my channel: https://www.youtube.com/@tradehiveonyt/videos
'''

# TradeHive's Video Splitter Agent🎬
import sys
...
INPUT_DIR = Path("/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/videos/raw_streams")
OUTPUT_DIR = Path("/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/videos/finished_clips")
TEMP_DIR = Path("/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/videos/temp")
YOUTUBE_MATERIALS_DIR = Path("/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/videos/youtube_materials")
...
class ClipsAgent:
    def __init__(self):
        ...
        self._setup_ai()
        self._setup_voice()
        cprint("🎬 TradeHive's Clips Agent initialized!", "green")
    ...
    def run(self):
        ...
        cprint("\n🎬 TradeHive's Clips Agent starting...", "cyan")
        ...
        try:
            ...
            if MODEL_TYPE == "ollama":
                response = self.model.generate_response(
                    system_prompt="You are TradeHive's Hype AI. You write short, exciting video intros.",
