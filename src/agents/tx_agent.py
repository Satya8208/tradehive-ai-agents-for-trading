'''
🌙 TradeHive's Transaction Scanner - Built with love by TradeHive 🚀
...
# 🌙 TradeHive: Calculate project root dynamically
...
CHECK_INTERVAL = 3
DISPLAY_DELAY = 0.5
BASE_URL = os.getenv("TRADEHIVE_API_BASE_URL", "http://localhost:8000")
SOUND_ENABLED = True
...
# Sound effects paths - 🌙 TradeHive: External repo (sibling to this repo)
SOUND_EFFECTS = [
