"""
🌙 TradeHive's RBI AI (Research-Backtest-Implement)
...
# RESEARCH_CONFIG = {
#     "type": "deepseek",
#     "name": "deepseek-v4-flash"  # Using DeepSeek Chat for research
# }
# 
# BACKTEST_CONFIG = {
#     "type": "deepseek", 
#     "name": "deepseek-v4-pro"  # Using DeepSeek V4 Pro for backtesting
# }
# 
# DEBUG_CONFIG = {
#     "type": "deepseek",
#     "name": "deepseek-v4-flash"  # Using DeepSeek Chat for debugging
# }
# 
# # DEBUG_CONFIG = {
# #     "type": "ollama",
...
# PACKAGE_CONFIG = {
#     "type": "deepseek",
#     "name": "deepseek-v4-flash"  # Using DeepSeek Chat for package optimization
# }
...
# RESEARCH_CONFIG = {
#     "type": "deepseek",
#     "name": "deepseek-v4-flash"  # Using Llama 3.2 for research
# }
...
# # PACKAGE_CONFIG = {
# #     "type": "deepseek",
# #     "name": "deepseek-v4-flash"  # Using Llama 3.2 for package optimization
# # }
...
# BACKTEST_MODEL = "deepseek-v4-pro"  # DeepSeek API for backtesting
...
def get_model_id(model):
    ...
    return "DR" if model == "deepseek-v4-pro" else "DC"
...
try:
    ...
    Anthropic = None
    cprint("⚠️ Anthropic SDK not installed. Claude models will be unavailable. (TradeHive note)", "yellow")
...
def init_deepseek_client():
    ...
    try:
        ...
        print("🌟 TradeHive's RBI AI is connecting to DeepSeek...")
        ...
        print("🚀 TradeHive's RBI AI ready to roll!")
        return client
...
def chat_with_model(system_prompt, user_content, model_config):
    ...
    try:
        ...
        cprint("🌟 TradeHive's RBI AI is thinking...", "yellow")
...
def process_trading_idea(idea: str) -> None:
    ...
    print("\n🚀 TradeHive's RBI AI Processing New Idea!")
...
if __name__ == "__main__":
    try:
        cprint(f"\n🌟 TradeHive's RBI AI Starting Up!", "green")
        ...
        cprint("\n👋 TradeHive's RBI AI shutting down gracefully...", "yellow")
    except Exception as e:
