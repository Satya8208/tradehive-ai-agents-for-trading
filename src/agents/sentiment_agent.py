...
class SentimentAgent:
    def __init__(self):
        ...
        cprint("🌙 TradeHive's Sentiment Agent initialized!", "green")
    ...
    def analyze_and_announce_sentiment(self, tweets):
        ...
        message = f"TradeHive's Sentiment Analysis: After analyzing {len(texts)} tweets, "
    ...
    def init_twitter_client(self):
        ...
        try:
            ...
            cprint("🌙 TradeHive's Sentiment Agent starting up...", "cyan")
            client = Client()
            client.load_cookies("cookies.json")
            cprint("🚀 TradeHive's cookies loaded successfully! Time to fly to the moon! 🌙", "green")
            return client
    ...
    async def get_tweets(self, query):
        ...
        try:
            cprint(f'🕒 Time is {datetime.now()} - TradeHive getting fresh tweets for {query}! 🌟', "cyan")
    ...
    async def run_async(self):
        ...
        cprint("🤖 TradeHive's Sentiment Analysis running...", "cyan")
        ...
        cprint("🌙 TradeHive's Sentiment Analysis complete! 🚀", "green")
...
if __name__ == "__main__":
    try:
        ...
        cprint(f"\n🌙 TradeHive's Sentiment Agent starting (checking every {CHECK_INTERVAL_MINUTES} minutes)...", "cyan")
        ...
        cprint("\n👋 TradeHive's Sentiment Agent shutting down gracefully...", "yellow")
    except Exception as e:
