...
class BookAgent:
    ...
    def __init__(self):
        ...
        cprint("🌙 TradeHive's Book Agent Initializing...", "cyan")
    ...
    def ask(self, question: str) -> str:
        ...
        try:
            response = self.model.generate_response(
                system_prompt="You are TradeHive's Knowledge Base AI 🌙. Answer questions based on the provided content only.",
                user_content=prompt,
                temperature=0.7
            )
...
def main():
    ...
    cprint("\n🌙 TradeHive's Knowledge Base Assistant", "cyan")
    ...
    cprint("\n👋 Thanks for using TradeHive's Knowledge Base Assistant! 🌙", "cyan")
