...
Created with ❤️ by TradeHive's AI Assistant
'''
...
MODEL_CONFIG = {
    "type": "openai",
    "name": "gpt-5.4-mini",  # GPT-5.4 Mini - Fast and capable
...
COMPLIANCE_PROMPT = """
You are TradeHive's Compliance Agent 🌙, an expert in analyzing ads for compliance with Facebook's advertising guidelines.
...
Your response MUST follow this format:
{
  ...
  "tradehive_message": "A fun message mentioning TradeHive 🌙"
}
...
class ComplianceAgent:
    ...
    def __init__(self, guidelines_path: Path = None):
        ...
        cprint("🌙 TradeHive's Compliance Agent initialized! 🌙", "magenta")
    ...
    def extract_frames(self, video_path: Path, output_folder: Path) -> List[Path]:
        ...
        try:
            ...
            for frame_number in range(0, frame_count, frame_interval):
                ...
                # Show progress
                if saved_count % 10 == 0:
                    cprint(f"💫 Extracted {saved_count} frames... TradeHive would be proud!", "green")
    ...
    def analyze_compliance(self, ad_name: str, frames_dir: Path, transcript: str) -> Dict:
        ...
        try:
            ...
            cprint("🌙 TradeHive's Compliance Agent is thinking deeply... 🌙", "magenta")
            ...
            try:
                ...
                cprint(f"TradeHive Message: {analysis.get('tradehive_message', 'TradeHive says: Keep those ads compliant! 🌙')}", "white", "on_blue")
    ...
    def process_all_videos(self) -> None:
        ...
        try:
            ...
            if not video_files:
                ...
                cprint(f"🌙 TradeHive says: Add some videos and try again! 🌙", "magenta")
                return
            ...
            cprint(f"🌟 TradeHive's Compliance Agent has completed all tasks! 🌟", "magenta")
        except Exception as e:
...
def main():
    ...
    print("🚀 Starting TradeHive's Compliance Agent 🚀")
    ...
    try:
        ...
        cprint("\n👋 TradeHive's Compliance Agent shutting down gracefully...", "yellow")
    except Exception as e:
