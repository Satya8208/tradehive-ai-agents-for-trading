...
🌊 SWARM MODE (Consensus - ~45-60 seconds per token):
   ...
   Active Swarm Models:
   1. Claude Sonnet 4.6 - Anthropic's latest reasoning model
...
TRADING_PROMPT = """
You are TradeHive's AI Trading Assistant 🌙
...
Remember: 
- TradeHive always prioritizes risk management! 🛡️
- Never trade USDC or SOL directly
- Consider both technical and strategy signals
"""

ALLOCATION_PROMPT = """
You are TradeHive's Portfolio Allocation Assistant 🌙
...
class TradingAgent:
    def __init__(self):
        ...
        cprint("\n🤖 TradeHive's LLM Trading Agent initialized!", "green")
...
{json.dumps(market_data['strategy_signals'], indent=2)}
                ...
                print(f"🎯 TradeHive's AI Analysis Complete for {token[:4]}!")
                return response
    ...
    def allocate_portfolio(self):
        ...
        try:
            ...
            allocation_prompt = f"""You are TradeHive's Portfolio Allocation AI 🌙
...
{{
    ...
    def execute_allocations(self, allocation_dict):
        ...
        try:
            print("\n🚀 TradeHive executing portfolio allocations...")
    ...
    def run_trading_cycle(self, strategy_signals=None):
        ...
        try:
            ...
            cprint("\n📊 TradeHive's Trading Recommendations:", "white", "on_blue")
            ...
            if USE_PORTFOLIO_ALLOCATION and len(buy_recommendations) > 0:
                ...
                if allocation:
                    cprint("\n💼 TradeHive's Portfolio Allocation:", "white", "on_blue")
            ...
            cprint("🔧 TradeHive suggests checking the logs and trying again!", "white", "on_blue")

def main():
    """Main function to run the trading agent every 15 minutes"""
    cprint("🌙 TradeHive AI Trading System Starting Up! 🚀", "white", "on_blue")
    ...
    while True:
        try:
            ...
            cprint("\n👋 TradeHive AI Agent shutting down gracefully...", "white", "on_blue")
            break
        except Exception as e:
