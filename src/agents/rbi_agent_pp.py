"""
🌙 TradeHive's RBI AI v3.0 PARALLEL PROCESSOR 🚀
...
WORKING_BACKTEST_DIR = TODAY_DIR / "backtests_working"  # TradeHive's working iterations!
...
BACKTEST_PROMPT = """
You are TradeHive's Backtest AI 🌙 ONLY SEND BACK CODE, NO OTHER TEXT.
...
Use this data path: /Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/rbi/BTC-USD-15m.csv
...
def main():
    ...
    cprint(f"\n{'='*60}", "cyan", attrs=['bold'])
    cprint(f"🌟 TradeHive's RBI AI v3.0 PARALLEL PROCESSOR 🚀", "cyan", attrs=['bold'])
