...
def clean_ideas_file():
    ...
    # Colorful header
    print("\n" + "=" * 60)
    cprint(" 🧹 TRADEHIVE'S IDEA CLEANER 🧹 ", "white", "on_magenta")
    print("=" * 60 + "\n")
    ...
    # Final celebration
    print("\n" + "★" * 60)
    animate_text(" 🌟 TRADEHIVE'S IDEA CLEANER COMPLETED SUCCESSFULLY! 🌟 ", "white", "on_magenta", 0.01)
    print("★" * 60)
...
if __name__ == "__main__":
    try:
        ...
        cprint("🌙 Thank you for using TradeHive's Idea Cleaner! 🌙", "white", "on_magenta")
    except Exception as e:
