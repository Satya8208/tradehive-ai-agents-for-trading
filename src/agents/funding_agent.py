"""
💰 TradeHive's Funding Rate Monitor
...
MODEL_OVERRIDE = "deepseek-v4-flash"  # Set to "deepseek-v4-flash" to use DeepSeek
...
class FundingAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        if "deepseek" in self.active_model.lower():
            ...
            if deepseek_key:
                ...
                cprint("🚀 TradeHive's Funding Agent using DeepSeek override!", "green")
            else:
                self.deepseek_client = None
                cprint("⚠️ DEEPSEEK_KEY not found - DeepSeek model will not be available", "yellow")
        else:
            self.deepseek_client = None
            cprint(f"🎯 TradeHive's Funding Agent using Claude model: {self.active_model}!", "green")
    ...
    def _format_announcement(self, opportunities):
        ...
        try:
            ...
            if messages:
                return "ayo tradehive seven seven seven! " + " | ".join(messages) + "!"
            return None
    ...
    def run_monitoring_cycle(self):
        ...
        try:
            ...
            print("\n" + "╔" + "═" * 50 + "╗")
            print("║         🌙 TradeHive's Funding Party 🎉          ║")
            print("╠" + "═" * 50 + "╣")
