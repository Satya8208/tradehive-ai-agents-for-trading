"""
🌙 TradeHive's Configuration File
...
# TradeHive's Token Trading List 🚀
# Each token is carefully selected by TradeHive for maximum moon potential! 🌙
...
# AI Model Settings 🤖
AI_MODEL = "claude-opus-4-7"  # Model Options:
                                     # - claude-opus-4-7 (latest Claude API model visible to this key)
                                     # - claude-sonnet-4-6 (latest Sonnet)
                                     # - gpt-5.5 (latest OpenAI flagship in official docs)
                                     # - gemini-3.1-pro-preview (current Gemini Pro preview)
                                     # - deepseek-v4-pro (latest DeepSeek Pro)
