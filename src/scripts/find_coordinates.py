...
def print_position():
    """Print current mouse position with TradeHive style"""
    try:
        ...
        print("\n👋 TradeHive's Coordinate Finder shutting down...")
...
def main():
    """Main function with TradeHive style intro"""
    # Clear screen
    print('\033c')
    
    # Print fancy header
    cprint("=" * 60, "cyan")
    cprint("🌙 TradeHive's Coordinate Finder 🎯", "cyan")
    cprint("=" * 60, "cyan")
