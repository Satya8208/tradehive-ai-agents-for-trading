...
class TokenAccountTracker:
    def __init__(self):
        ...
        print(f"🌐 Connected to Helius RPC endpoint... TradeHive is ready! 🚀")

    def get_token_accounts(self, wallet_address: str) -> Dict:
        """Get all token accounts for a specific wallet address"""
        print(f"🔍 TradeHive is fetching token accounts for {wallet_address}...")
    ...
    def track_all_wallets(self):
        ...
        print(f"🚀 TradeHive's Token Tracker starting up...")
