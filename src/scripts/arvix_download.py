...
"""
🌙 TradeHive's arXiv Paper Downloader 🚀
...
DOWNLOAD_DIRECTORY = os.path.join("/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data", "Arxiv")
...
TRADEHIVE_QUOTES = [
    "🌙 TradeHive says: To the moon with knowledge! 🚀",
    "🌙 Thanks for using TradeHive's arXiv downloader! 💫",
    "🌙 TradeHive approves this download! 👍",
    "🌙 TradeHive reminds you: Knowledge is power! 📚",
    "🌙 TradeHive says: Learning never stops! 🧠",
    "🌙 TradeHive's secret to success: Read more papers! 📝",
    "🌙 TradeHive is proud of you for doing research! 🔍",
]
...
def print_banner():
    ...
    banner = f"""
    {Colors.CYAN}╔═══════════════════════════════════════════════════════════╗
    ║ {Colors.YELLOW}🌙  TRADEHIVE's arXiv PAPER DOWNLOADER  🌙{Colors.CYAN}                ║
    ╚═══════════════════════════════════════════════════════════╝{Colors.ENDC}
    """
    print(banner)
    print(f"{Colors.GREEN}{random.choice(TRADEHIVE_QUOTES)}{Colors.ENDC}\n")
    ...
    try:
        if show_progress:
            ...
            progress_bar = tqdm(total=file_size, unit='B', unit_scale=True, 
                               desc=f"🌙 TradeHive's Download", ncols=100)
        ...
        print(f"{Colors.CYAN}{random.choice(TRADEHIVE_QUOTES)}{Colors.ENDC}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="🌙 TradeHive's arXiv Paper Downloader")
...
if __name__ == "__main__":
    try:
        ...
        print(f"{Colors.CYAN}👋 Thanks for using TradeHive's arXiv Downloader! Goodbye!{Colors.ENDC}")
    except Exception as e:
