"""
🌙 TradeHive's ADX + VWAP Backtest Strategy
...
print(f"🌙 TradeHive loading data from: {data_path}")
...
print("\n" + "="*80)
print("🌙 TRADEHIVE'S OPTIMIZED RESULTS 🌙")
print("="*80)
print(optimization_results)

print("\n" + "="*80)
print("🌙 TRADEHIVE'S BEST PARAMETERS 🌙")
print("="*80)
