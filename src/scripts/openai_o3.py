"""
🌙 TradeHive's OpenAI O3-mini Test Script
...
def test_o3_mini():
    ...
    cprint("🚀 TradeHive's O3-mini test launching...", "cyan")
    ...
    cprint("🤔 TradeHive is thinking deep thoughts...", "yellow")
    try:
        ...
        cprint("✨ TradeHive's O3-mini model responded successfully!", "green")
        print("\n🎯 Generated Response:")
        print(response.choices[0].message.content)
        
    except Exception as e:
        cprint(f"❌ Oops! Even TradeHive hits bumps sometimes: {str(e)}", "red")

if __name__ == "__main__":
    cprint("🌙 TradeHive AI Lab - O3-mini Test", "magenta")
    test_o3_mini()
