# 🌙 TradeHive's Custom Strategies Directory
...
- Use TradeHive's utility functions from nice_funcs.py
...
## Questions?
Check out the example strategy or reach out to TradeHive for help! 🌙 🚀 