...
STRATEGIES_FOLDER = "/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/web_search_research/final_strategies"
```
...
DATA_DIR = "/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/rbi"

# CSV file with strategy ideas (classic mode only)
IDEAS_FILE = "/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/rbi_pp_multi/ideas.txt"
```
...
```
============================================================
🌟 TradeHive's RBI AI v3.0 PARALLEL PROCESSOR + MULTI-DATA 🚀
============================================================
...
*Part of the TradeHive AI Agents for Trading project*

**GitHub**: https://github.com/tradehive-ai-agents-for-trading
