...
```
Green Background (White Text):  +1 tradehive123  (flashes for 3 seconds)
```

When someone enters their Solana address:
```
Green Background (White Text):  tradehive123 addy saved  (flashes for 3 seconds)
```
...
tradehive123,7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU,42
...
When someone chats:
```
+1 tradehive123  (green background, white text, flashes for 3 seconds)
```

When someone enters Solana address:
```
tradehive123 addy saved  (green background, white text, flashes for 3 seconds)
```
...
**TradeHive's Giveaway Agent** - Track participation, reward engagement 🚀🌙
