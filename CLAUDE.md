...
# /Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/rbi/BTC-USD-15m.csv
```
...
**`src/agents/api.py`**: `TradeHiveAPI` class for custom TradeHive API endpoints
...
- Sample data available at `/Users/md/Dropbox/dev/github/tradehive-ai-agents-for-trading/src/data/rbi/BTC-USD-15m.csv`
...
2. **TradeHive API** - Custom signals (liquidations, funding rates, OI, copybot data)
