...
Scrape tweets from Twitter/X "For You" feed using Codex in Chrome MCP tools. Collects tweet data including handle, text, URL, and engagement metrics, opens each tweet in a separate browser tab, and optionally saves to JSON.
