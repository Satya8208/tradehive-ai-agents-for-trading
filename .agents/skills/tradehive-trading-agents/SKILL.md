...
- Supports: Codex, GPT-4, DeepSeek, Groq, Gemini, Ollama
...
Edit `src/config.py`:
```python
AI_MODEL = "Codex-3-haiku-20240307"  # Fast, cheap
# AI_MODEL = "Codex-3-sonnet-20240229"  # Balanced
# AI_MODEL = "Codex-3-opus-20240229"  # Most powerful
```
